...
START=$(date +%s)
rsync -aAXv /* $BACKUPDIR/$HOSTNAME-$DATE --exclude auto/* --exclude dev/* --exclude proc/* --exclude sys/* --exclude tmp/* --exclude run/* --exclude mnt/* --exclude media/* --exclude lost+found --exclude var/lib/pacman/sync/*
FINISH=$(date +%s)
